      ...
      drills: [
        {
          type: "visual",
          items: [
            { id: "short-a-1", type: "sound", content: "a", audioHint: "Short a says /a/ as in apple" },
          ],
          masteryThreshold: 90,
        ...
        },
        {
          type: "auditory",
          items: [
            { id: "short-a-aud-1", type: "sound", content: "a", audioHint: "/a/" },
          ],
          masteryThreshold: 85,
          consecutiveCorrect: 3,
        },
      ...
      drills: [
        {
          type: "visual",
          items: [
            { id: "short-i-1", type: "sound", content: "i", audioHint: "Short i says /i/ as in igloo" },
          ],
          masteryThreshold: 90,
          consecutiveCorrect: 3,
        },
      ...
      drills: [
        {
          type: "visual",
          items: [
            { id: "short-o-1", type: "sound", content: "o", audioHint: "Short o says /o/ as in octopus" },
          ],
          masteryThreshold: 90,
          consecutiveCorrect: 3,
        },
      ...
      drills: [
        {
          type: "visual",
          items: [
            { id: "short-u-1", type: "sound", content: "u", audioHint: "Short u says /u/ as in umbrella" },
          ],
          masteryThreshold: 90,
          consecutiveCorrect: 3,
        },
      ...
      drills: [
        {
          type: "visual",
          items: [
            { id: "short-e-1", type: "sound", content: "e", audioHint: "Short e says /e/ as in elephant" },
          ],
          masteryThreshold: 90,
          consecutiveCorrect: 3,
        },
